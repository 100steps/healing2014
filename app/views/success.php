...
<html>
	<head>
		...
		<link rel="stylesheet" type="text/css" href="/css/success.css?rnd=<?php echo rand();?>" />
	...
	<body>
		<div>		
			...
			<div class="page page-1-2 hide">
				<div class="wrap">
					<img class="img_1 hide pt-page-scaleUp" src="http://wechat.100steps.net/img/ad_img1.png" />
					<img class="img_2 hide pt-page-scaleUp" src="http://wechat.100steps.net/img/ad_img2.png" />
				</div>
			</div>
		</div>
	</body>
	...
	<script src="/js/success.js?rnd=<?php echo rand();?>"></script>
</html>